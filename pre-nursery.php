<?php 
$pageTitle = "Pre Nursery Program - The Foundation Play School";
include 'header.php'; 
?>

<meta name="description" content="Our Pre Nursery program provides a gentle introduction to a structured environment for children aged 1.5 to 2.5 years, fostering growth through sensory play, music, and storytelling.">

    <!-- ===== HERO SECTION ===== -->
    <section class="relative pt-32 pb-20 overflow-hidden -mt-[72px] bg-brandTeal/10">
        ...
        <div class="absolute top-0 left-0 w-full h-full opacity-50 pointer-events-none">
            ...
            <i class="fa-solid fa-puzzle-piece absolute bottom-20 right-[10%] text-brandTeal/30 text-3xl float-anim"></i>
        ...
        <div class="max-w-[1300px] mx-auto px-5 relative z-10 flex flex-col md:flex-row items-center gap-12 mt-8">
            ...
            <div class="flex-1 text-center md:text-left">
                <span class="inline-flex items-center gap-2 bg-white text-brandTeal font-bold text-sm tracking-widest uppercase mb-6 px-4 py-2 rounded-full shadow-sm">
                    <i class="fa-solid fa-baby-carriage"></i> Ages 1.5 - 2.5 Years
                </span>
                <h1 class="text-5xl md:text-7xl font-heading font-bold leading-tight mb-6 text-brandDarkBlue">
                    Pre Nursery <br>
                    <span class="text-brandTeal relative">
                        Program
                        <svg class="absolute -bottom-2 left-0 w-full h-3 text-brandTeal/30" viewBox="0 0 100 10" preserveAspectRatio="none">
                ...
                <p class="text-textLight mb-8 text-lg md:text-xl leading-relaxed max-w-lg mx-auto md:mx-0">
                    A gentle, joy-filled introduction to a structured learning environment. We help your toddler build confidence through sensory play, music, and interactive storytelling.
                </p>
                <div class="flex flex-wrap justify-center md:justify-start gap-4">
                    <a href="contact.php" class="bg-brandTeal text-white px-8 py-4 rounded-full font-bold shadow-lg shadow-brandTeal/30 hover:-translate-y-1 transition duration-300">
            ...
            <div class="flex-1 relative flex justify-center w-full max-w-lg mx-auto">
                <div class="relative w-72 h-72 sm:w-[400px] sm:h-[400px] bg-white p-3 rounded-blob shadow-2xl z-20 hover:scale-[1.02] transition duration-500 overflow-hidden">
                    <img src="assets/img/pre_nursery_hero.png" alt="Pre Nursery Toddlers" class="w-full h-full object-cover rounded-blob">
                </div>
    ...
    <section class="pt-10 pb-16 bg-white relative">
        <div class="max-w-[1300px] mx-auto px-5">
            <div class="text-center mb-16 max-w-3xl mx-auto">
                <span class="text-brandTeal font-bold text-sm tracking-widest uppercase mb-3 block">Program Overview</span>
                <h2 class="text-4xl md:text-5xl font-heading font-bold text-brandDarkBlue mb-6">Nurturing Early Independence</h2>
                <p class="text-textLight text-lg leading-relaxed">
                    Our Pre Nursery curriculum is designed to balance warm, individualized care with engaging group activities. We focus on transitioning toddlers from their home environment into a social classroom setting at a comfortable, guided pace.
                </p>
            </div>
    ...
    <section class="pt-12 pb-20 bg-brandBg relative overflow-hidden">
        ...
        <div class="max-w-[1100px] mx-auto px-5 relative z-10">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl md:text-5xl font-heading font-bold text-brandDarkBlue">A Day in Pre Nursery</h2>
            </div>
            ...
            <div class="space-y-4">
                ...
                <details class="group bg-white rounded-[20px] shadow-sm [&_summary::-webkit-details-marker]:hidden">
                    <summary class="flex justify-between items-center font-bold font-heading text-xl cursor-pointer list-none p-6 text-brandDarkBlue hover:text-brandOrange transition">
                        <span>What are the key areas in the Playgroup curriculum?</span>
                    ...
                    <div class="p-6 pt-0 text-textLight leading-relaxed">
                        <ul class="space-y-2">
                            <li class="flex items-center gap-3"><i class="fa-solid fa-check text-brandOrange text-sm"></i> Promoting positive peer social interaction</li>
                            <li class="flex items-center gap-3"><i class="fa-solid fa-check text-brandOrange text-sm"></i> Opportunities for basic motor development</li>
                            <li class="flex items-center gap-3"><i class="fa-solid fa-check text-brandOrange text-sm"></i> Math Readiness (Number Recognition)</li>
                            <li class="flex items-center gap-3"><i class="fa-solid fa-check text-brandOrange text-sm"></i> Language Readiness (Letter Recognition)</li>
                            <li class="flex items-center gap-3"><i class="fa-solid fa-check text-brandOrange text-sm"></i> Exploration based learning</li>
                        </ul>
                    </div>
                </details>
                ...
                <details class="group bg-white rounded-[20px] shadow-sm [&_summary::-webkit-details-marker]:hidden">
                    ...
                    <div class="p-6 pt-0 text-textLight leading-relaxed">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <span class="bg-white border border-gray-200 px-4 py-1.5 rounded-full text-sm text-brandDarkBlue shadow-sm">Artsy</span>
                            ...
                            <span class="bg-white border border-gray-200 px-4 py-1.5 rounded-full text-sm text-brandDarkBlue shadow-sm">Tell-a-Tale</span>
                            <span class="bg-white border border-gray-200 px-4 py-1.5 rounded-full text-sm text-brandDarkBlue shadow-sm">Library</span>
                            <span class="bg-white border border-gray-200 px-4 py-1.5 rounded-full text-sm text-brandDarkBlue shadow-sm">Sciencify</span>
                            ...
                            <span class="bg-white border border-gray-200 px-4 py-1.5 rounded-full text-sm text-brandDarkBlue shadow-sm">Critical Thinking - Problem solving</span>
                ...
                <details class="group bg-white rounded-[20px] shadow-sm [&_summary::-webkit-details-marker]:hidden">
                    ...
                    <div class="p-6 pt-0 text-textLight leading-relaxed">
                        <p class="mb-4">Our daily sessions are packed with structured and unstructured joy:</p>
                        <div class="flex flex-wrap gap-2">
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Circle Time</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Free Play</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Knowledge Time</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Language Time</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Numeracy Time</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Talk Time</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Outdoor</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Indoor</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Celebration of festivals & special days</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Field Trips</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Puppet shows and skits</span>
                            <span class="bg-white border border-brandTeal/20 text-brandTeal px-4 py-1.5 rounded-full text-sm font-bold shadow-sm">Fruit</span>
                        </div>
                    </div>
                </details>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                ...
                <div class="bg-brandBg rounded-[30px] overflow-hidden shadow-sm card-hover group">
                    ...
                    <div class="p-6">
                        ...
                        <h4 class="font-heading font-bold text-xl text-brandDarkBlue mb-2 leading-snug">5 Signs Your Child is Ready for Pre Nursery</h4>
                        <p class="text-textLight text-sm mb-4 leading-relaxed">Not sure if your toddler is ready for structured school? Look for these five readiness signs before making the decision.</p>
                        <div class="flex items-center justify-between border-t border-gray-200 pt-4">
    ...
    <section class="pt-10 pb-20 bg-brandDarkBlue relative overflow-hidden">
        ...
        <div class="max-w-[800px] mx-auto px-5 text-center relative z-10">
            <h2 class="text-4xl md:text-5xl font-heading font-bold text-white mb-6 leading-tight">
                Ready to take the <span class="text-brandTeal">first step?</span>
            </h2>
            <p class="text-white/70 text-lg mb-10 leading-relaxed">
                Give your toddler the perfect gentle start to their educational journey. Contact us to schedule a tour of our Pre Nursery classrooms.
            </p>
            <div class="flex flex-wrap justify-center gap-4">
                <a href="contact.php" class="bg-brandTeal text-white px-10 py-4 rounded-full font-bold shadow-xl shadow-brandTeal/30 hover:-translate-y-1 transition">
