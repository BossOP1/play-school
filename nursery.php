            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                ...
                <div class="bg-brandBg rounded-[30px] overflow-hidden shadow-sm card-hover group">
                    ...
                    <div class="p-6">
                        ...
                        <h4 class="font-heading font-bold text-xl text-brandDarkBlue mb-2 leading-snug">5 Signs Your Child is Ready for Nursery</h4>
                        <p class="text-textLight text-sm mb-4 leading-relaxed">Not sure if your child is ready for our Nursery program? Look for these five readiness signs before making the decision.</p>
                        <div class="flex items-center justify-between border-t border-gray-200 pt-4">
